...
*/
$baseUrl = 'http://zinteo.com/';
//$baseUrl = 'http://guru.mk/guruliks/';
/*
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = '/store/webs/guru/';
$baseDir = '/home/gurumk/public_html/zinteo.com/';
/*
 * ### Advanced Settings
 */
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . 'userfiles/thumbs/',
		'directory' => $baseDir . 'userfiles/thumbs/',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['RoleSessionVar'] = 'currentRole';
//session_start();
