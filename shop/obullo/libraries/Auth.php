...
Class OB_Auth {
    ...
    public $tablename          = 'admins';     // The name of the database tablename
    ...
    public $md5                = false;        // Whether to use md5 hash.
    public $allow_login        = TRUE;        // Whether to allow logins to be performed on this page.

    public $post_username      = 'username';     // The name of the form field that contains the username to authenticate.
    public $post_password      = 'password';     // The name of the form field that contains the password to authenticate.
