...
Class OB_Database_pdo extends OB_crud {
    ...
    */
    ...
    /**
     * Added by Hristijan Stojanoski
     * Fetch result as class object
     *
     * @return object
     */
    public function as_class($class_name) {
    
    	return $this->Stmt->fetchAll(PDO::FETCH_CLASS|PDO::FETCH_PROPS_LATE, $class_name);
