...
if (! function_exists ( 'lang' )) {
	function lang($item = '') {
		...
		$item = ($item == '' or ! isset ( $lang->language [$item] )) ? $item : $lang->language [$item];
...
class OB_Lang {
	 ...
	 * @param string $idiom
	 *        	the language folder (english, etc.)
	 * @param string $dir
	 *        	is it base language file ?
	 * @param bool $return
	 *        	return to $lang variable if you don't merge
	 * @return mixed
	 */
