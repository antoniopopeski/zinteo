...
<head>
<meta charset="utf-8" />
<title>Vetfriend24 | Administrator Login</title>
<meta
...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
		...
		<div class="login bg-black animated fadeInDown">
			<!-- begin brand -->
			<div class="login-header" style="text-align:center;top:-110px;">
				<img src="http://vetfriend24.kriipton.com/shop/assets/img/logo.jpg">
				<div class="brand">Vetfriend24 Shop Admin</div>
			...
			<div class="login-content">
				<form action="" method="POST" class="margin-bottom-0">
					...
					<div class="login-buttons">
						<button type="submit"
							class="btn btn-primary-vetshop btn-block btn-lg">Sign me in</button>
					</div>
				</form>
			</div>
		</div>
