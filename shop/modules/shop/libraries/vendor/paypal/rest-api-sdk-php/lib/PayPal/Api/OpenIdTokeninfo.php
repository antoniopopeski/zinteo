...
class OpenIdTokeninfo extends PayPalResourceModel {
	 ...
	 * @method POST
	 * @param array $params
	 *        	(allowed values are client_id, client_secret, grant_type, code and redirect_uri)
	...
	public static function createFromAuthorizationCode($params, $clientId = null, $clientSecret = null, $apiContext = null, $restCall = null) {
		...
		$json = self::executeCall ( "/v1/identity/openidconnect/tokenservice", "POST", http_build_query ( array_intersect_key ( $params, $allowedParams ) ), array (
	 ...
	 * @method POST
	 * @param array $params
	 *        	(allowed values are grant_type and scope)
	 *        	(required) client_id from developer portal
	 *        	(required) client_secret from developer portal
