...
class CreditCard extends PayPalResourceModel {
	...
	/**
	 * Type of the Card.
	 * Currently supporting Visa, Mastercard, Amex, Discover and Maestro
	 ...
	 * Generated and provided by the facilitator. This is required when creating or using a stored funding instrument in vault.
	 *
	...
	/**
	 * A user provided, optional convenvience field that functions as a unique identifier for the merchant on behalf of whom this credit card is being stored for.
	 * Note that this has no relation to PayPal merchant id
	 *
	 ...
	 * This ID can help to avoid unintentional use or misuse of credit cards. This ID can be any value you would like to associate with the saved card, such as a UUID, username, or email address. Required when using a stored credit card if a payer_id was originally provided when storing the credit card in vault.
	 *
	...
	/**
	 * A unique identifier of the bank account resource.
	 * Generated and provided by the facilitator so it can be used to restrict the usage of the bank account to the specific merchant.
	 *
	 ...
	 * Only the modified fields need to be passed in the request.
	 *
