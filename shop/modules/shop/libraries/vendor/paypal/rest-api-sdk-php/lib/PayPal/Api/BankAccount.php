...
class BankAccount extends PayPalResourceModel {
	 ...
	 * For more information refer to http://en.wikipedia.org/wiki/International_Bank_Account_Number.
	 ...
	 * For more information refer to http://en.wikipedia.org/wiki/Bank_code.
	 *
	 ...
	 * Use this field if the user authorization needs to be captured due to any privacy requirements.
	 *
	 ...
	 * Generated and provided by the facilitator so it can be used to restrict the usage of the bank account to the specific merchnt.
	 *
	...
	public function create($apiContext = null, $restCall = null) {
		$payLoad = $this->toJSON ();
		$json = self::executeCall ( "/v1/vault/bank-accounts", "POST", $payLoad, null, $apiContext, $restCall );
		$this->fromJson ( $json );
		return $this;
	}
	...
	public function delete($apiContext = null, $restCall = null) {
		...
		$payLoad = "";
		self::executeCall ( "/v1/vault/bank-accounts/{$this->getId()}", "DELETE", $payLoad, null, $apiContext, $restCall );
		return true;
	}
	
	/**
	 * Update information in a previously saved bank account.
	...
	public function update($patchRequest, $apiContext = null, $restCall = null) {
		...
		$json = self::executeCall ( "/v1/vault/bank-accounts/{$this->getId()}", "PATCH", $payLoad, null, $apiContext, $restCall );
		$this->fromJson ( $json );
		return $this;
	}
}
