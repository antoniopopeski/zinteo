...
class PayoutItemDetails extends PayPalModel {
	/**
	 * An ID for an individual payout.
	 * Provided by PayPal, such as in the case of getting the status of a batch request. 30 characters max.
	 *
	...
	/**
	 * Generated ID for the transaction.
	 * 30 characters max.
	 *
	...
	/**
	 * An ID for the batch payout.
	 * Generated by PayPal. 30 characters max.
	 *
