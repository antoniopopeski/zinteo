...
class PayoutItem extends PayPalResourceModel {
	/**
	 * The type of identification for the payment receiver.
	 * If this field is provided, the payout items without a `recipient_type` will use the provided value. If this field is not provided, each payout item must include a value for the `recipient_type`.
	 *
	 ...
	 * The note is provided by the payment sender. This note can be any string. 4000 characters max.
	 *
	 * @param string $note        	
	 *
	 * @return $this
	 ...
	 * In a call response, the format of this value corresponds to the `recipient_type` specified in the request. 127 characters max.
	 *
	...
	public static function get($payoutItemId, $apiContext = null, $restCall = null) {
		...
		$payLoad = "";
		$json = self::executeCall ( "/v1/payments/payouts-item/$payoutItemId", "GET", $payLoad, null, $apiContext, $restCall );
	 ...
	 * If an unclaimed item is not claimed within 30 days, the funds will be automatically returned to the sender. This call can be used to cancel the unclaimed item prior to the automatic 30-day return.
	 *
	 * @param string $payoutItemId        	
	 * @param ApiContext $apiContext
	 *        	is the APIContext for this call. It can be used to pass dynamic configuration and credentials.
