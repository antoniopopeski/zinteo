...
class PaymentDetail extends PayPalModel {
	 ...
	 * In the case of the mark-as-paid API, payment type is EXTERNAL and this is what is now supported. The PAYPAL value is provided for backward compatibility.
	 ...
	 * Mandatory field in case the type value is PAYPAL.
	 *
	 ...
	 * This field is mandatory if the value of the type field is EXTERNAL.
