...
class Order extends PayPalResourceModel {
	...
	/**
	 * Capture a payment on an order by passing the order_id in the request URI.
	 * In addition, include the amount of the payment and indicate whether this is a final capture for the given authorization in the body of the request JSON. To issue this request, an original payment call must specify an intent of order.
	 *
	...
	/**
	 * Void (cancel) an order by passing the order_id in the request URI.
	 * Note that an order cannot be voided if payment has already been partially or fully captured.
	 *
	 * @param ApiContext $apiContext
	 *        	is the APIContext for this call. It can be used to pass dynamic configuration and credentials.
	 * @param PayPalRestCall $restCall
	...
	/**
	 * Authorize an order by passing the order_id in the request URI.
