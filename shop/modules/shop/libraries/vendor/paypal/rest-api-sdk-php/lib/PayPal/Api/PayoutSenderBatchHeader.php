...
class PayoutSenderBatchHeader extends PayPalModel {
	...
	/**
	 * The subject line text for the email that PayPal sends when a payout item is completed.
	 * (The subject line is the same for all recipients.) Maximum of 255 single-byte alphanumeric characters.
	 *
	...
	/**
	 * The type of ID for a payment receiver.
