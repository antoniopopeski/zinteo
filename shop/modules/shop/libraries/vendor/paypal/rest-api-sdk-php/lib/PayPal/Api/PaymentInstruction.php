...
class PaymentInstruction extends PayPalResourceModel {
	...
	/**
	 * Retrieve a payment instruction by passing the payment_id in the request URI.
	 * Use this request if you are implementing a solution that includes delayed payment like Pay Upon Invoice (PUI).
	 *
