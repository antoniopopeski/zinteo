...
class WebProfileTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGet($obj, $mockApiContext) {
		...
		$mockPayPalRestCall->expects ( $this->any () )->method ( 'execute' )->will ( $this->returnValue ( WebProfileTest::getJson () ) );
	...
	public function testGetList($obj, $mockApiContext) {
		...
		$mockPayPalRestCall->expects ( $this->any () )->method ( 'execute' )->will ( $this->returnValue ( json_encode ( array (
				json_decode ( WebProfileTest::getJson () ) 
		) ) ) );
	...
	public function mockProvider() {
		$obj = self::getObject ();
		$mockApiContext = $this->getMockBuilder ( 'ApiContext' )->disableOriginalConstructor ()->getMock ();
		return array (
				array (
						$obj,
						$mockApiContext 
