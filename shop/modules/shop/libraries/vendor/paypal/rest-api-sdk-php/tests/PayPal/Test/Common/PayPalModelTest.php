...
class ListModelTestClass extends PayPalModel {
	 ...
	 *
	 * @access public
	 * @param SimpleModelTestClass $list2
	 *        	array of SimpleModelTestClass
	 */
...
class PayPalModelTest extends PHPUnit_Framework_TestCase {
	...
	public function testEmptyObject() {
		...
		$this->assertEquals ( '{"field1":"parent","nested1":{}}', $parent->toJSON () );
	...
	public function testNestedConversion() {
		...
		$this->assertEquals ( '{"field1":"parent","nested1":{"field1":"value 1","field2":"value 2"}}', $parent->toJSON () );
