...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="width:16%;float:right;z-index: 9999;">
				<a href="http://FreeHTMLtoPDF.com/?convert=<?php echo base_url()?>shop/pdfMake/<?php echo $order->getId();?>" class="btn btn-orange" target="_blank">Download Invoice</a>
		</div>
<main>
