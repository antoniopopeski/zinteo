...
$autoload ['helper'] ['ob/request'] = '';
$autoload ['helper'] ['ob/url'] = '';
$autoload ['helper'] ['ob/text'] = '';
$autoload ['helper'] ['app/auth'] = '';
$autoload ['helper'] ['app/language'] = '';
 ...
 * |
 */
$autoload ['lib'] ['app/AppCore'] = array (
		FALSE 
);
$autoload ['lib'] ['app/Singleton'] = array (
		FALSE 
);
$autoload ['lib'] ['app/DBApp'] = array (
		FALSE 
);
