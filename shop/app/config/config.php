...
$config ['domain_name'] = "http://" . $_SERVER ["HTTP_HOST"];
 ...
 */
$config ['debug_backtrace'] = array (
		'enabled' => 'E_ALL ^ (E_NOTICE | E_WARNING)',
		'padding' => 5 
);
 ...
 * |
 */
$config ['encryption_key'] = "de213d13fr 1d12fe21dff2";
