...
$auth['tablename']           = 'admins';     // The name of the database tablename
$auth['username_col']        = 'username';   // The name of the table field that contains the username.
$auth['password_col']        = 'password';  // The name of the table field that contains the password.
$auth['username_length']     = '60';        // The string length of the username.
$auth['password_length']     = '60';        // The string length of the password.
$auth['md5']                 = false;        // Whether to use md5 hash ?
...
$auth['not_ok_url']          = '/admin/login';     // Redirect Url for Unsuccessfull logins
$auth['ok_url']              = '/admin'; // Redirect Url Successfull logins
