 ...
 * |
 */
$routes ['default_controller'] = 'shop/shop/index'; // or welcome/controller/method name
$routes ['404_override'] = '';
$routes ['user/login'] = 'user/users/login';
$routes ['user/register'] = 'user/users/register';
$routes ['user/logout'] = 'user/users/logout';
$routes ['user/profile'] = 'user/dashboard/profile';
