...
$(document).on('click','.endmenu',function(){
    localStorage.setItem('selectedMenu',$(this).text());
});

if (localStorage.selectedMenu) {
    $('.endmenu:contains("' + localStorage.selectedMenu + '")').parent().parent().show();
    $('.endmenu:contains("'+localStorage.selectedMenu+'")').css('color','#FFF');
    $('.endmenu:contains("' + localStorage.selectedMenu + '")').parent().parent().parent().addClass('active');
}