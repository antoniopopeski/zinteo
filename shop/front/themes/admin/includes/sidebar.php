            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a class="endmenu"  href="<?php echo site_url('admin/crud/menu');?>">Menu</a>
                     ...
                     <li><a class="endmenu"  href="<?php echo site_url('admin/crud/sidebar');?>">Sidebar</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-sub">
             ...
             <li class="has-sub">
                ...
                <ul class="sub-menu">
                     ...
                     <li><a class="endmenu"  href="<?php echo site_url('admin/crud/socialnetworks');?>">Social Networks</a></li>
                      <li><a class="endmenu"  href="<?php echo site_url('admin/crud/footerlinks');?>">Footer Links</a></li>
                </ul>
            </li>

            <li class="has-sub expand">
                <a href="/shop/admin/dashboard" style="background: #54390E;">
                    <i class="fa fa-laptop"></i> 
                    <span>To the Shop Admin -></span></a>
            </li>
