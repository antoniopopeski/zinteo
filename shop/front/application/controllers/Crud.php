...
';
    ...
    public function sidebar() {
    	...
    	$crud->set_subject('sidebar');
    	
    	$crud->set_table('sidebar');
    	
    	$crud->set_rules('name','Name', 'required');
    	
    	$crud->set_rules("text", "Text", 'required');
	...
	$crud->set_subject('socialnetowkrs');

	$crud->set_table('socialnetworks');

  
        $crud->set_rules('name','Name','required');

        $crud->set_rules('link','Link','required');
    ...
    public function footerlinks() {
    	...
    	$crud->set_subject('footerlinks');
    
    	$crud->set_table('footerlinks');
