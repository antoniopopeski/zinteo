...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/assets/uploads/images";  ///webroot/uploads';
//$moxieManagerConfig['filesystem.rootpath'] = 'C:\wamp\www\tinymce_test\upload';
...
$moxieManagerConfig['filesystem.local.wwwroot'] = $_SERVER["DOCUMENT_ROOT"]."/assets/uploads/images";
//    $moxieManagerConfig['filesystem.local.wwwroot'] = 'C:\wamp\www\tinymce_test\upload';
//$moxieManagerConfig['filesystem.local.urlprefix'] = '{proto}://{host}/';
$moxieManagerConfig['filesystem.local.urlprefix'] = "http://vetfriend24.kriipton.com/assets/uploads/images";
